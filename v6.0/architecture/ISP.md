...
are [OEAPI endpoints](https://open-education-api.github.io/specification/v5/docs.html).
...
![OEAPI objects and their relationships in a schema](https://oeapi.eu/specification/v5/OOAPIv5_model.png)
...
| education                          | "/programmes" "/courses" "/components" | A generalisation object that is used mainly for aggregating shared information across programmes, courses and components.                                                                                                                |
...
| component                          | "/components"                        | Educational components, aimed at the realisation of competences or objectives in the field of knowledge, insight, attitudes and skills that the person who completes the component must have.                                          |
| offering                           | "/offerings"                         | A generalisation object that is used mainly for aggregating shared information on the offerings of programmes, courses and components. Offerings have a global timeframe, or academicSession, e.g. a period to which students can enrol |
...
| academicSession                    | "/academic-sessions"                 | The academic sessions provide information about the different time periods a programme, course or component (education) can be offered                                                                                                  |
...
| educationSpecification             | Generic description of a general education object such as a programme or course: "RIO opleidingseenheid"                                                        | PHM       | MHP      |
