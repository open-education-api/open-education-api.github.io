...
* All contributions, including documentation, filenames, and discussions, should be written in British English.
...
* The spec must comply with the [OpenAPI Specification v3.0](https://github.com/OAI/OpenAPI-Specification/)
...
* Parameter or property names are written as [lowerCamelCase](https://nl.wikipedia.org/wiki/CamelCase), also for abbreviations (e.g. `organisationUnitId`).
* Path names are written as [kebab-case](https://en.wikipedia.org/wiki/Kebab_case) (e.g. `/organisations/{id}`).
