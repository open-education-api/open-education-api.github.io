import{n as r,o as e}from"./entry.client-BWshqLWg.js";const o=""+new URL("ooapi_v6-C47QEScn.png",import.meta.url).href,d="OpenAPI (fka Swagger) specification for the Open Education API.",c=[],a={lastModifiedTime:"2026-03-03T23:04:16.000Z"},l="pages/index.mdx";function i(s){const n={code:"code",img:"img",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"OpenAPI (fka Swagger) specification for the Open Education API."}),`
...
//# sourceMappingURL=index-BrDXp3Td.js.map
