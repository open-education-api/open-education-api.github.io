import{n as r,o as e}from"./entry.client-BWHcCYeb.js";const o=""+new URL("ooapi_v6-C47QEScn.png",import.meta.url).href,d="OpenAPI (fka Swagger) specification for the Open Education API.",c=[{depth:1,text:"OOAPI Information Model",id:"ooapi-information-model",children:[{depth:2,text:"Model",id:"model"},{depth:2,text:"Relationship Definitions",id:"relationship-definitions"},{depth:2,text:"Notes",id:"notes"},{depth:2,text:"Background Information",id:"background-information"},{depth:2,text:"API Paths",id:"api-paths"}]}],a={lastModifiedTime:"2026-03-04T12:24:52.000Z"},l="pages/index.mdx";function s(i){const n={code:"code",h1:"h1",h2:"h2",img:"img",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"ooapi-information-model",children:"OOAPI Information Model"}),`
`,e.jsx(n.p,{children:"OpenAPI (fka Swagger) specification for the Open Education API."}),`
...
`,e.jsx(n.h2,{id:"relationship-definitions",children:"Relationship Definitions"}),`
...
`]}),`
`,e.jsx(n.h2,{id:"background-information",children:"Background Information"}),`
...
`,e.jsx(n.h2,{id:"api-paths",children:"API Paths"}),`
...
`]})]})}function h(i={}){const{wrapper:n}={...r(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{l as __filepath,h as default,d as excerpt,a as frontmatter,c as tableOfContents};
//# sourceMappingURL=index-bgWxfJB3.js.map
